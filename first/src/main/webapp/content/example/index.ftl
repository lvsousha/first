...
Ext.onReady(function(){
	<#include  "example/objectfield.ftl">
	<#include  "example/colorfield.ftl">

	<#include  "example/monthfield.ftl">
	<#include  "example/basic.ftl">
	<#include  "example/layout.ftl">

	var content = Ext.create('Ext.tab.Panel', {
		id: 'mainContent',
		plain: false,
		items:[basicTab,layoutTab],
		listeners: {}
	});
